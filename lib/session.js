...
export async function createSession(res,phone){
  ...
  res.setHeader("Set-Cookie","dm_session="+encodeURIComponent(raw)+"; Path=/; HttpOnly"+(process.env.NODE_ENV==="production"?"; Secure":"")+"; SameSite=Lax; Max-Age="+(30*24*60*60));
}
...
export async function clearSession(req,res){
  ...
  res.setHeader("Set-Cookie","dm_session=; Path=/; HttpOnly"+(process.env.NODE_ENV==="production"?"; Secure":"")+"; SameSite=Lax; Max-Age=0");
}
